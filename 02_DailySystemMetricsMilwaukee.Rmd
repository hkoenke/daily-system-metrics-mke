...
tarp_summary_table %>%
  select(tarp_summary2,Census,Staffing,RN_Variance)%>%
  kbl(col.names = NULL, escape = F, align = 'c') %>%
  kable_paper(full_width = F, html_font = "Arial", position="left")%>%
  add_header_above(c(" ", paste0(format(Sys.Date()-days(1),"%m/%d/%y"), " \nActuals"),
                          paste0(format(Sys.Date()-days(1),"%m/%d/%y"), " \nActuals"),
                          paste0(format(Sys.Date()-days(1),"%m/%d/%y"), " \nActuals")),bold=T, underline=T, font_size = 10, align="center")%>%
  add_header_above(c("TARP Summary - All Bedded", "Census", "Staffing", "RN Variance"),bold=T, underline=T, font_size = 14, background="lightgray", align="center", border_left=TRUE,border_right=TRUE)
...
system_metrics_table %>%
  ...
  add_header_above(c("System Metrics"=2),bold=T, underline=T, font_size = 14, background="lightgray", align="left", border_left=TRUE,border_right=TRUE)
